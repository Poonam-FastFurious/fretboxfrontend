...
export const useAuthStore = create((set, get) => ({
      ...
      login: async (email, password) => {
            ...
            try {
                  const res = await axios.post(`${Baseurl}/api/v1/user/login`, { email, password }, { withCredentials: true });
      ...
      updateProfile: async (file) => {
            ...
            try {
                  ...
                  const res = await axios.patch(`${Baseurl}/api/v1/user/update-profile`, formData, {
                        withCredentials: true,
                        headers,
                  });
      ...
      updateUser: async (data) => {
            ...
            try {
                  ...
                  const res = await axios.patch(`${Baseurl}/api/v1/user/update_user`, data, {
                        withCredentials: true,
                        headers,
                  });
